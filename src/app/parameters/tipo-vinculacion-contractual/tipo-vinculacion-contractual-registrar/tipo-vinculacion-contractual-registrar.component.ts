...
@Component({
  selector: 'app-tipo-vinculacion-contractual-registrar',
  templateUrl: './tipo-vinculacion-contractual-registrar.component.html',
  styleUrls: ['./tipo-vinculacion-contractual-registrar.component.scss']
})
export class TipoVinculacionContractualRegistrarComponent implements OnInit {

  suscription: Subscription = new Subscription;
  form: FormGroup; 
  originalFormValues: any;
  idRegistro: number =0;
  endPoint="TipoVinculacionContractual"

  constructor(  private tipoVinculacionContractualService: TipoVinculacionContractualService,
...
//------------------------------------------------------------------------------------------
  ngOnInit(): void {
      this.suscription= this.tipoVinculacionContractualService.obtenerDatosRegistroObservable$().subscribe(data => {
    ...
    ActualizarRegistro(){
      ...
      this.formulariosService.compareAndGeneratePatch(jsonPatch, this.form.value, this.originalFormValues);
        ...
        this.sharedService.patch(this.endPoint, this.idRegistro, jsonPatch).subscribe(
          response => {
            this.tipoVinculacionContractualService.obtenerListadoRegistros('/' + this.endPoint);
