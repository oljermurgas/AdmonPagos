...
@Component({
  selector: 'app-tipo-concepto-facturacion-registrar',
  templateUrl: './tipo-concepto-facturacion-registrar.component.html',
  styleUrls: ['./tipo-concepto-facturacion-registrar.component.scss']
})
export class TipoConceptoFacturacionRegistrarComponent implements OnInit {
    suscription: Subscription = new Subscription;
    form: FormGroup; 
    originalFormValues: any;
    idRegistro: number =0;
    endPoint="TipoConceptoFacturacion"
