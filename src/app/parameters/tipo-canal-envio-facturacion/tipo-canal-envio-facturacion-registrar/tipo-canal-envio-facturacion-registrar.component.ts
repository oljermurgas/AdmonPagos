...
@Component({
  selector: 'app-tipo-canal-envio-facturacion-registrar',
  templateUrl: './tipo-canal-envio-facturacion-registrar.component.html',
  styleUrls: ['./tipo-canal-envio-facturacion-registrar.component.scss']
})
export class TipoCanalEnvioFacturacionRegistrarComponent implements OnInit {
